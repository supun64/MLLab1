# -*- coding: utf-8 -*-
"""ML-lab1-label4-190375K.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/19NJT6Swzuzux8JWdgSEAarTUpNlUahPw
"""
...
"""Make copies of the label 4 of the datasets to be used in the models without feature engineering"""

# Make a copy of the fourth label of the train dataset
_train_label4 = train_label4.copy()

# Make a copy of the fourth label of the valid dataset
_valid_label4 = valid_label4.copy()

# Make a copy of the fourth label of the test dataset
_test_label4 = test_label4.copy()
...
best_model.fit(_train_features, _train_label4)
...
accuracy = accuracy_score(_train_label4, y_pred_base_train)
precision = precision_score(_train_label4, y_pred_base_train, average='weighted' , zero_division=1)
recall = recall_score(_train_label4, y_pred_base_train, average='weighted')
...
accuracy = accuracy_score(_valid_label4, y_pred_base_valid)
precision = precision_score(_valid_label4, y_pred_base_valid, average='weighted', zero_division=1)
recall = recall_score(_valid_label4, y_pred_base_valid, average='weighted')
...
"""# Predicting Label 4 - Feature Engineering

Predict label 4 with feature engineering techniques
...
destination = '/content/drive/MyDrive/Colab Notebooks/ML-labs/Lab1/data/190375K_label_4.csv'
