# -*- coding: utf-8 -*-
"""ML-lab1-label3-190375K.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17njBr-QkZHs_jnm0tABtozxzNYrlaTNw
"""
...
train_data = train_d.dropna(subset=train_d.columns[-4:], how='any')

"""Fill the null values in the features with their means in the train, valid and test datasets."""

# Fill null values with mean in train, valid and test dataset
...
# Make a copy of the third label of the train dataset
_train_label3 = train_label3.copy()

# Make a copy of the third label of the valid dataset
_valid_label3 = valid_label3.copy()

# Make a copy of the third label of the test dataset
_test_label3 = test_label3.copy()
...
_test_features_ = scaler.transform(_test_features)

"""Use the raw scaled features to train the best model which is KNN"""

best_model = KNeighborsClassifier()

best_model.fit(_train_features, _train_label3)
...
accuracy = accuracy_score(_train_label3, y_pred_base_train)
precision = precision_score(_train_label3, y_pred_base_train, average='weighted' , zero_division=1)
recall = recall_score(_train_label3, y_pred_base_train, average='weighted')
...
accuracy = accuracy_score(_valid_label3, y_pred_base_valid)
precision = precision_score(_valid_label3, y_pred_base_valid, average='weighted', zero_division=1)
recall = recall_score(_valid_label3, y_pred_base_valid, average='weighted')
...
Predict label 3 with feature engineering techniques
...
# All models perform very well. Chose KNN
...
destination = '/content/drive/MyDrive/Colab Notebooks/ML-labs/Lab1/data/190375K_label_3.csv'
