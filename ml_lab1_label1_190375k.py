# -*- coding: utf-8 -*-
"""ML-lab1-label1-190375K.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/117x_UZDF2byH2C7AYJh2MpJF4y3dQZ_E
"""
...
# Drop rows with null values in the target labels
...
# Replacing null values with mean in train, valid, test dataset
...
Make copies of the features and labels of the datasets to use in the model without feature engineering
"""
...
best_model.fit(_train_features, _train_label1)
...
accuracy = accuracy_score(_train_label1, y_pred_base_train)
precision = precision_score(_train_label1, y_pred_base_train, average='weighted' , zero_division=1)
recall = recall_score(_train_label1, y_pred_base_train, average='weighted')
...
accuracy = accuracy_score(_valid_label1, y_pred_base_valid)
precision = precision_score(_valid_label1, y_pred_base_valid, average='weighted', zero_division=1)
recall = recall_score(_valid_label1, y_pred_base_valid, average='weighted')
...
"""# Predicting Label 1 - Feature Engineering

Predict label 1 with feature engineering techniques
...
Metrics for Decision Tree on train data:
Accuracy: 1.00
Precision: 1.00
Recall: 1.00
...
destination = '/content/drive/MyDrive/Colab Notebooks/ML-labs/Lab1/data/190375K_label_1.csv'
